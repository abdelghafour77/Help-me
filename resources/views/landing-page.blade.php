    ...
    <section class="bg-white dark:bg-gray-900 h-screen flex items-center">
        <div class="grid max-w-screen-xl px-4 py-10 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 lg:py-20">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h3 class="max-w-2xl mb-9 text-2xl font-extrabold leading-none tracking-tight md:text-3xl xl:text-4xl dark:text-white">A public platform building the definitive collection of coding questions & answers</h3>
                <p class="max-w-2xl mb-9 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Find the best answer to your technical question, help others answer theirs.<br>
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    ...
                    <form action="/search/" class="flex items-center lg:w-9/12 w-full">
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="{{ asset('assets/landing-page/hero.png') }}" alt="hero image">
            </div>
        </div>
    </section>
    <!-- End block -->
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <figure class="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    <p class="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">"Ask the right questions, and the answers will always reveal themselves."</p>
                </blockquote>
                <figcaption class="flex items-center justify-center mt-6 space-x-3">
                    <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                        <div class="pr-3 font-medium text-gray-900 dark:text-white">- Oprah Winfrey -</div>
                    </div>
                </figcaption>
            </figure>
        </div>
        ...
        <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            ...
            <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 class="mb-2 text-2xl font-bold dark:text-white">{{ App\Models\Question::count() }}+ Questions</h3>
                    <p class="font-light text-gray-500 dark:text-gray-400">Over {{ App\Models\Question::count() }} since we started.</p>
                </div>
                <div>
                    <svg class="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path>
                    </svg>
                    <h3 class="mb-2 text-2xl font-bold dark:text-white">{{ App\Models\User::count() }}+ Users</h3>
                    <p class="font-light text-gray-500 dark:text-gray-400">Trusted by over {{ App\Models\User::count() }} users around the world</p>
                </div>
                ...
                <div>
                    ...
                    <p class="font-light text-gray-500 dark:text-gray-400">Answer per day</p>
                </div>
                <div>
                    <svg class="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h3 class="mb-2 text-2xl font-bold dark:text-white">{{ App\Models\Tag::count() }}+ Tags</h3>
