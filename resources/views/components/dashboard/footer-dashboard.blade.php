<section class="bg-gray-50 dark:bg-gray-900">
    ...
    <p class="py-10 text-sm text-center text-gray-500 bg-gray-50 dark:bg-gray-900">
        {{ __('Made with') }} <span class="text-red-500">&hearts;</span> {{ __('by') }} <a href="https://github.com/abdelghafour77" target="_blank" class="font-bold hover:underline">Abdelghafour AOUAD</a>
    </p>
</section>
