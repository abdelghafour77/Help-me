        ...
        <div class="flex flex-col p-2 py-6 m-h-screen max-w-screen-lg px-4 mx-auto lg:grid-cols-12 ">
            <form action="/search/">
                <div class="bg-white dark:bg-gray-700 items-center justify-between w-full flex rounded-full shadow-md p-2 mb-5">
                    ...
                    <input class="font-bold rounded-full w-full py-4 pl-4 text-gray-700 bg-gray-100 dark:bg-gray-600 dark:text-gray-200 leading-tight focus:outline-none focus:shadow-outline lg:text-sm text-xs" value="{{ old('search', request()->get('search')) }}" name="search"
            ...
            <div class="pt-5 flex justify-between wrapper items-center">
                <div class="px-3">
                    <div class="lg:text-2xl md:text-xl text-lg lg:pt-3 p-1 font-black text-gray-300">Tag:
                        <span>{{ $tag->name }}</span>
                    </div>
